...
// Route untuk form pengiriman email
Route::get('/send-email-form', function () {
    return view('send-email-form'); // Buat view form sederhana
});
// Route untuk memproses pengiriman email (method POST)
Route::post('/send-welcome-email', [UserController::class, 'sendWelcomeEmail'])->name('send.welcome.email');
// Atau jika menggunakan method dengan parameter
Route::get('/send-email/{email}', [UserController::class, 'sendWelcomeEmailToUser']);
